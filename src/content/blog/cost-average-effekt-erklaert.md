...
faq:
  - question: 'Was ist der Cost-Average-Effekt?'
    answer: 'Der Durchschnittskosteneffekt entsteht, wenn du regelmäßig einen festen Eurobetrag investierst — unabhängig vom Kurs. Bei niedrigen Kursen kaufst du automatisch mehr Anteile, bei hohen weniger. Der durchschnittliche Einkaufspreis liegt dadurch unter dem einfachen arithmetischen Mittel der Kurse.'
  - question: 'Ist die Einmalanlage dem Sparplan überlegen?'
    answer: 'Bei langfristig steigenden Märkten historisch ja — wer früher mehr Kapital investiert, profitiert länger vom Zinseszins. Studien wie "Dollar-Cost Averaging Just Means Taking Risk Later" (Vanguard 2012) zeigen das. Für Anleger ohne großes Startkapital ist der Sparplan trotzdem die praktikable Lösung; der Renditeunterschied ist langfristig kleiner als oft angenommen.'
  - question: 'Sollte ich den Sparplan in Kursrückgängen pausieren?'
    answer: 'Nein. Genau in Kursrückgängen wirkt der Cost-Average-Effekt am stärksten, weil du mehr Anteile pro Euro bekommst. Wer pausiert, verpasst die günstigsten Kaufmomente und ruiniert die Renditeerwartung. Konsequent weiterlaufen lassen ist fast immer die bessere Entscheidung.'
  - question: 'Wie oft sollte ich investieren — monatlich, wöchentlich, quartalsweise?'
    answer: 'Monatlich ist bei Brokern Standard und in der Praxis völlig ausreichend. Wöchentliche Sparpläne bieten keinen nennenswerten Rendite-Vorteil, verursachen aber mehr Buchungsaufwand. Quartalsweise ist akzeptabel, reduziert aber die Glättung durch Cost-Averaging leicht.'
sources:
  - title: 'Dollar-Cost Averaging Just Means Taking Risk Later'
    publisher: 'Vanguard Research'
    year: 2012
  - title: 'SPIVA Europe Scorecard (langfristige Marktrenditen)'
