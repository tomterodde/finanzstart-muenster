---
title: 'IRR (Internal Rate of Return) einfach erklärt — die PE-Renditekennzahl'
description: 'Der IRR ist die wichtigste Renditekennzahl im Private Equity. Was die Internal Rate of Return bedeutet, wie sie sich vom Multiple unterscheidet und warum die Zeit entscheidet.'
pubDate: '2026-06-30'
heroImage: '../../assets/blog-placeholder-3.jpg'
category: 'Private Equity'
tldr: 'Der IRR (Internal Rate of Return) ist die jährliche Rendite eines Investments unter Berücksichtigung des Zeitpunkts aller Zahlungen. Private Equity misst Erfolg primär in IRR, weil die Kennzahl belohnt, wenn Kapital schnell zurückfließt. Typische PE-Zielwerte liegen bei 20–25 % IRR.'
faq:
  - question: 'Was ist der IRR einfach erklärt?'
    answer: 'Der IRR (Internal Rate of Return, deutsch: interner Zinsfuß) ist die jährliche Verzinsung, bei der alle Ein- und Auszahlungen eines Investments sich rechnerisch ausgleichen. Er drückt aus, wie viel Prozent Rendite ein Investment pro Jahr erwirtschaftet hat — unter Berücksichtigung, wann das Geld geflossen ist.'
  - question: 'Was ist der Unterschied zwischen IRR und Multiple?'
    answer: 'Der Multiple (MOIC) zeigt, wie oft sich das eingesetzte Kapital vervielfacht hat — etwa 2x. Der IRR berücksichtigt zusätzlich die Zeit: 2x in 3 Jahren ergeben einen viel höheren IRR als 2x in 8 Jahren. Multiple misst die Höhe, IRR die Geschwindigkeit der Rendite.'
  - question: 'Was ist ein guter IRR im Private Equity?'
    answer: 'Private-Equity-Fonds zielen typischerweise auf einen Netto-IRR von 15–20 % für Investoren und einen Brutto-IRR von 20–25 % auf Deal-Ebene. Werte über 30 % gelten als sehr stark, sind aber oft auf kurze Haltedauern oder hohen Fremdkapitalhebel zurückzuführen.'
sources:
  - title: 'Private Equity Performance Measurement Standards (GIPS)'
    publisher: 'CFA Institute'
    year: 2025
    url: 'https://www.cfainstitute.org/standards/gips'
---
