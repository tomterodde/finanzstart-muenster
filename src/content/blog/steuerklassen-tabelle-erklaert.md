---
title: 'Steuerklassen-Tabelle: Alle 6 Klassen erklärt — und wann sich der Wechsel lohnt'
description: 'Steuerklassen 1 bis 6 in der Tabelle: Wer welche Klasse hat, welche Freibeträge gelten und wann sich der Steuerklassenwechsel lohnt — etwa vor dem Elterngeld.'
pubDate: '2026-07-20'
heroImage: '../../assets/blog-placeholder-5.jpg'
category: 'Vermögensaufbau'
tldr: 'Deutschland hat sechs Lohnsteuerklassen: I (ledig), II (alleinerziehend), III/V und IV/IV bzw. IV mit Faktor (verheiratet) sowie VI (Zweitjob). Die Steuerklasse ändert nicht deine Jahressteuer, aber dein monatliches Netto — und damit Lohnersatzleistungen wie Elterngeld oder ALG 1. Ein Wechsel ist mehrmals pro Jahr möglich und vor allem vor der Geburt eines Kindes bares Geld wert.'
faq:
  - question: 'Welche Steuerklasse habe ich als lediger Berufseinsteiger?'
    answer: 'Ledige ohne Kinder sind automatisch in Steuerklasse I. Alleinerziehende können in Steuerklasse II wechseln und erhalten dort den Entlastungsbetrag von 4.260 € pro Jahr plus 240 € je weiterem Kind. Ein Zweitjob über der Minijob-Grenze läuft immer über Steuerklasse VI.'
  - question: 'Ändert die Steuerklasse, wie viel Steuern ich insgesamt zahle?'
  ...
  - question: 'Wann lohnt sich der Steuerklassenwechsel vor der Geburt?'
    answer: 'Das Elterngeld bemisst sich am durchschnittlichen Nettogehalt der zwölf Monate vor dem Mutterschutz. Wechselt der Elternteil, der in Elternzeit geht, rechtzeitig in Steuerklasse III, steigt das Netto — und damit das Elterngeld. Der Wechsel muss dafür in der Regel mindestens sieben Monate vor Beginn des Mutterschutzes beantragt sein.'
  - question: 'Wie oft kann man die Steuerklasse wechseln?'
    answer: 'Seit 2020 ist der Steuerklassenwechsel mehrmals pro Jahr möglich. Der Antrag läuft über das Finanzamt (Formular oder ELSTER) und wirkt ab dem Folgemonat. Ehepaare können damit flexibel auf Gehaltsänderungen, Elternzeit oder drohende Arbeitslosigkeit reagieren.'
sources:
  - title: 'Einkommensteuergesetz § 38b (Lohnsteuerklassen)'
