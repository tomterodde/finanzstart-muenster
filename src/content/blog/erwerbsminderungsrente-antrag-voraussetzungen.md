---
title: 'Erwerbsminderungsrente beantragen: Voraussetzungen, Ablauf, Fallstricke'
description: 'Wann hat man Anspruch auf Erwerbsminderungsrente, wie läuft der Antrag ab — und was tun, wenn der Antrag abgelehnt wird?'
pubDate: '2026-04-29'
heroImage: '../../assets/blog-placeholder-5.jpg'
category: 'Einkommenssicherung'
tldr: 'Erwerbsminderungsrente nach §§ 43, 240 SGB VI: Volle EM-Rente bei weniger als 3 Stunden täglicher Arbeitsfähigkeit in irgendeinem Beruf, teilweise EM-Rente bei 3-6 Stunden. Voraussetzungen (§ 43 Abs. 1 SGB VI): allgemeine Wartezeit 5 Jahre + 3 Jahre Pflichtbeiträge in den letzten 5 Jahren vor Eintritt der Erwerbsminderung. Verweisung auf "irgendeinen" Beruf (abstrakte Verweisbarkeit) — fundamental anders als BU-Versicherung, die nur auf konkret ausgeübten Beruf abstellt. Zurechnungszeit bis zum 65. Lebensjahr (§ 59 SGB VI) erhöht die Rente fiktiv — seit 2019 stufenweise Verlängerung bis 67 J. Durchschnittliche EM-Rente 2024 laut DRV: 1.012 €/Monat (volle), 566 €/Monat (teilweise). Ablehnungsquote Erstanträge: 42 % laut DRV-Rentenversicherungsbericht 2024 — Widerspruch oft erfolgreich.'
faq:
  - question: 'Wer hat Anspruch auf Erwerbsminderungsrente?'
    answer: 'Drei Voraussetzungen (§ 43 SGB VI): 1) Gesundheitsstufe — volle EM bei <3 Stunden täglicher Arbeitsfähigkeit in irgendeinem Beruf, teilweise EM bei 3-6 Stunden. 2) Allgemeine Wartezeit — mindestens 5 Jahre Rentenversicherungszeit (§ 50 SGB VI), inkl. Kindererziehungszeiten. 3) 3 Jahre Pflichtbeiträge in den letzten 5 Jahren vor Eintritt der EM — kritisch für Berufseinsteiger, bei Lücken (z. B. Studium, Auslandsjahre) besteht oft kein Anspruch. Ausnahme: schulische Ausbildung bis 17. Lebensjahr zählt als Anwartschaftszeit.'
  - question: 'Wie hoch ist die Erwerbsminderungsrente?'
    answer: 'Berechnung wie bei Altersrente: Entgeltpunkte × Zugangsfaktor × Rentenwert. Bei voller EM-Rente: Zugangsfaktor 1,0 (wenn Rentenbeginn bei oder nach 65), sonst Abschläge bis 10,8 % (3,6 % pro Jahr vorzeitig, max. 3 Jahre). Bei teilweiser EM: halbe Rente. Zurechnungszeit (§ 59 SGB VI) fügt fiktive Rentenpunkte bis zum Alter 65 hinzu — Durchschnittsverdiener mit 10 Jahren Erwerbstätigkeit und voller EM mit 35 erhält dadurch rund 1.200 €/Monat statt nur rund 400 € ohne Zurechnungszeit. Durchschnittswert 2024: 1.012 € (volle), 566 € (teilweise).'
  - question: 'Was heißt "Verweisung auf irgendeinen Beruf"?'
    answer: 'Abstrakte Verweisbarkeit (§ 43 Abs. 2 Nr. 2 SGB VI): Die gesetzliche Rente prüft nicht, ob man im erlernten oder zuletzt ausgeübten Beruf noch arbeiten kann — sondern ob irgendeine Tätigkeit auf dem allgemeinen Arbeitsmarkt 3-6 Stunden täglich möglich wäre. Beispiel: Chirurg kann wegen Tremor nicht mehr operieren, aber theoretisch 6 Stunden am Schreibtisch sitzen → keine EM-Rente. Das ist der zentrale Nachteil gegenüber einer privaten BU-Versicherung, die nur auf den zuletzt ausgeübten Beruf abstellt. Für Akademiker und Facharbeiter ist abstrakte Verweisbarkeit oft existenzbedrohend.'
  - question: 'Wie lange dauert der Antrag auf Erwerbsminderungsrente?'
    answer: 'Durchschnittlich 3-6 Monate, in komplexen Fällen länger. Ablauf: 1) Antrag formlos oder per Formular R0100 bei DRV einreichen. 2) Ärztliche Unterlagen, Krankenhausberichte, Attest beifügen. 3) DRV beauftragt Gutachten — meist bei DRV-eigenen oder vertraglich gebundenen Gutachtern (Rentenbegutachtung § 109 SGB VI). 4) Entscheidung per Bescheid. Bei Ablehnung Widerspruchsfrist 1 Monat (§ 84 SGG). Laut DRV 2024 werden 42 % der Erstanträge abgelehnt, 48 % der Widersprüche sind erfolgreich. Parallel: Krankengeld maximal 78 Wochen (§ 48 SGB V), danach Aussteuerung.'
  - question: 'Was tun bei Ablehnung der Erwerbsminderungsrente?'
    answer: 'Vier Schritte: 1) Widerspruch innerhalb 1 Monat nach Bescheid (Ausschlussfrist § 84 SGG), gerne ohne Begründung zur Fristwahrung. 2) Akteneinsicht bei DRV beantragen — Gutachten einsehen, Widersprüche und fehlende Befunde identifizieren. 3) Neue Atteste und Fachgutachten nachreichen, idealerweise von behandelnden Spezialisten. 4) Sozialrechtsanwalt oder Sozialverband (VdK, SoVD) einschalten — Anwälte arbeiten oft erfolgsabhängig, Sozialverbandsmitgliedschaft ca. 100 €/Jahr ersetzt anwaltliche Vertretung. Bei Ablehnung im Widerspruch: Klage beim Sozialgericht innerhalb 1 Monat (§ 87 SGG), gerichtskostenfrei.'
sources:
  - title: 'Sozialgesetzbuch Sechstes Buch (SGB VI) §§ 43, 50, 59, 240 Erwerbsminderungsrente'
    publisher: 'Bundesministerium der Justiz'
    year: 2025
  - title: 'Rentenversicherungsbericht 2024 — Erwerbsminderungsrenten'
    publisher: 'Deutsche Rentenversicherung Bund'
    year: 2024
  - title: 'Sozialgerichtsgesetz (SGG) §§ 84, 87 Widerspruch und Klage'
    publisher: 'Bundesministerium der Justiz'
    year: 2025
---
