...
| Anlage | Volatilität p. a. (typisch) |
|---|---|
| Tagesgeld | ~ 0 % |
| Bundesanleihen | 4–6 % |
| Welt-ETF (MSCI World) | 15–20 % |
| Einzelne DAX-Aktie | 25–35 % |
| Schwellenländer-ETF | 22–28 % |
| Krypto | 60–100 % |
...
| Krise | MSCI World Drawdown | Erholungszeit |
|---|---|---|
...
**1. Asset-Allokation**
Mischung aus Aktien und Anleihen reduziert die Gesamtschwankung überproportional, weil Anleihen oft unkorreliert oder gegenläufig zu Aktien laufen.

| Portfolio | Volatilität | Erwartete Rendite |
|---|---|---|
| 100 % Aktien | ~ 18 % | ~ 7 % |
| 60/40 | ~ 11 % | ~ 5,5 % |
| 30/70 | ~ 7 % | ~ 4 % |
...
| Zeitraum | Renditebereich |
|---|---|
| 1 Jahr | −56 % bis +59 % |
| 5 Jahre | −7 % bis +21 % p. a. |
| 15 Jahre | +1,3 % bis +13,6 % p. a. |
| 20 Jahre | immer positiv |
