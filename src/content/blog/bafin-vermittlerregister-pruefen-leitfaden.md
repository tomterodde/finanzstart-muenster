...
**Schritt 1:** Aufruf vermittlerregister.info
**Schritt 2:** Eingabe Registrierungsnummer → Direkter Datensatz-Aufruf
**Schritt 3:** Prüfung:
...
1. **Registrierungsnummer erfragen** (30 Sekunden)
2. **vermittlerregister.info aufrufen** (10 Sekunden)
3. **Datensatz prüfen** (Status aktiv, Zulassungsart, Berufshaftpflicht — 2 Minuten)
...
1. **Jeder seriöse Berater nennt seine Registrierungsnummer souverän.** Ausweichen ist ein klares Warnsignal.

2. **Die Prüfung ist Pflicht — nicht Wahl.** Bei jeder Beratungsbeziehung mit Finanzgeschäften (BU, Altersvorsorge, Investments) sollte die Registerprüfung Standard sein.
