...
| Zulassung | Was darf vermittelt werden? |
|---|---|
| § 34d GewO | Versicherungen (Sach, Leben, BU, Haftpflicht etc.) |
| § 34f GewO | Investmentfonds und Vermögensanlagen |
| § 34c GewO | Immobiliendarlehen |
...
| Termin | Dauer | Inhalt |
|---|---|---|
| 1 | 60–90 Min | Kennenlernen, Beratungsbedarf klären |
| 2 | 90–120 Min | Detaillierte Bedarfsanalyse |
| 3 | 60–90 Min | Strategie-Präsentation, Produktvorschläge |
| 4 | 60 Min | Vertragsabschluss nach Bedenkzeit |
...
| # | Red Flag | Bedeutung |
|---|---|---|
| 1 | Pauschale Renditeversprechen ("8 % garantiert") | Gesetzlich unzulässig, immer Risikohinweis |
| 2 | Druck zum sofortigen Abschluss | Quick-Sale ohne Bedenkzeit |
| 3 | Nur ein Versicherer im Portfolio | Strukturvertrieb, kein freier Marktzugang |
| 4 | Kein schriftliches Protokoll | § 18 WpHG-Verstoß |
| 5 | Produktempfehlung im Erstgespräch | Reihenfolge falsch, keine echte Analyse |
| 6 | Cold Calls oder anonyme Kontaktaufnahme | Unprofessioneller Vertriebsfunnel |
| 7 | Bonus für sofortigen Abschluss | Intransparente Vergütungsstruktur |
| 8 | Provisionen werden verschwiegen | § 70 WpHG-Verstoß |

**Bei einem Red Flag:** Vorsichtig sein, Termin verschieben, weitere Quellen einholen.
**Bei mehreren Red Flags:** Termin abbrechen, anderen Berater suchen.
