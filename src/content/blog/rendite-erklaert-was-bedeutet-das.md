---
title: 'Rendite einfach erklärt: Was bedeutet das eigentlich?'
description: 'Was ist Rendite, wie wird sie berechnet und was ist der Unterschied zwischen nominaler und realer Rendite? Grundlagen für Berufseinsteiger.'
pubDate: '2026-04-08'
heroImage: '../../assets/blog-placeholder-2.jpg'
category: 'Grundlagen'
tldr: 'Rendite ist der prozentuale Ertrag einer Geldanlage pro Jahr. Entscheidend ist die Unterscheidung zwischen nominaler Rendite (vor Inflation) und realer Rendite (nach Abzug der Inflation). Historische Werte p.a.: Tagesgeld 0–3 %, Bundesanleihen 1–4 %, Welt-ETF 6–9 %. Rendite und Risiko sind untrennbar — wer 10 % bei vollem Kapitalschutz verspricht, lügt. Nach Abzug von 26,375 % Abgeltungssteuer und Produktkosten (TER) bleibt deutlich weniger als die Bruttorendite.'
faq:
  - question: 'Was ist Rendite?'
    answer: 'Rendite ist der Ertrag einer Geldanlage in Prozent des eingesetzten Kapitals pro Jahr (p.a.). Formel: (Gewinn / eingesetztes Kapital) × 100. Aus 1.000 € Einsatz und 70 € Gewinn nach einem Jahr ergeben sich 7 % Rendite p.a.'
  - question: 'Was ist der Unterschied zwischen nominaler und realer Rendite?'
    answer: 'Nominale Rendite ist der ausgewiesene Wert vor Inflation. Reale Rendite = nominale Rendite minus Inflationsrate. Bei 2 % Sparbuchzins und 3 % Inflation beträgt die reale Rendite −1 % — dein Kapital verliert trotz positiven Zinsen an Kaufkraft.'
  - question: 'Welche Rendite ist bei welcher Anlageform realistisch?'
    answer: 'Historische Langfristrenditen: Tagesgeld 0–3 %, Bundesanleihen 1–4 %, breit gestreute Welt-Aktien-ETFs 6–9 % vor Steuern und Kosten, Einzelaktien stark schwankend. Bei ETFs liegt die reale Rendite (nach Inflation) historisch bei 5–7 % p.a. über Zeiträume von 20+ Jahren.'
  - question: 'Wie beeinflussen Steuern und Kosten die Rendite?'
    answer: 'Die Abgeltungssteuer in Deutschland beträgt 26,375 % (25 % plus Soli). Aus 7 % Bruttorendite werden netto rund 5,2 %. Zusätzlich verringern Fondskosten (TER) die Rendite: ein aktiv gemanagter Fonds mit 1,5 % TER frisst bei 6 % Rendite ein Viertel der Erträge — ein ETF mit 0,2 % TER kaum messbar.'
  - question: 'Warum ist der arithmetische Durchschnitt irreführend?'
    answer: 'Beispiel: +50 % im Jahr 1, −50 % im Jahr 2. Arithmetisch wäre der Durchschnitt 0 %. Tatsächlich: 1.000 € × 1,5 × 0,5 = 750 € — ein Verlust von 25 %. Relevant ist das geometrische Mittel (CAGR = Compound Annual Growth Rate), nicht der arithmetische Durchschnitt.'
sources:
  - title: 'DAX-Rendite-Dreieck (Historische Aktienrenditen)'
    publisher: 'Deutsches Aktieninstitut (DAI)'
    year: 2024
  - title: 'Verbraucherpreisindex (Inflation)'
