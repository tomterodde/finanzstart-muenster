---
title: 'Tagesgeld vs. Festgeld: Unterschied, Zinsen und wann sich was lohnt'
description: 'Tagesgeld oder Festgeld für deinen Notgroschen? Unterschiede bei Verfügbarkeit, Zinsbindung und Einlagensicherung einfach erklärt — mit Entscheidungshilfe.'
pubDate: '2026-08-15'
heroImage: '../../assets/blog-placeholder-2.jpg'
category: 'Vermögensaufbau'
tldr: 'Tagesgeld ist täglich verfügbar bei variablem Zinssatz — ideal für den Notgroschen. Festgeld bindet das Geld für eine feste Laufzeit (meist 3 bis 60 Monate) zu einem fixen Zinssatz, der bei längeren Laufzeiten meist etwas über dem Tagesgeldzins liegt. Beide sind über die gesetzliche Einlagensicherung bis 100.000 € pro Person und Bank EU-weit abgesichert. Wer flexibel bleiben will, nutzt Tagesgeld; wer Geld über einen bekannten Zeitraum nicht braucht, kann mit einer Festgeldleiter zusätzliche Zinsen mitnehmen, ohne komplett auf Flexibilität zu verzichten.'
faq:
  - question: 'Was ist der Unterschied zwischen Tagesgeld und Festgeld?'
    answer: 'Tagesgeld ist täglich verfügbar — Ein- und Auszahlungen sind jederzeit möglich, der Zinssatz ist variabel und kann sich jederzeit ändern. Festgeld bindet das Geld für eine vorher vereinbarte Laufzeit (typisch 3 bis 60 Monate) zu einem über die gesamte Laufzeit fixen Zinssatz — dafür ist ein vorzeitiger Zugriff meist nicht oder nur mit Zinsverlust möglich.'
  - question: 'Ist mein Geld auf Tagesgeld- und Festgeldkonten sicher?'
    answer: 'Ja, innerhalb der gesetzlichen Grenzen. Die EU-weite Einlagensicherung schützt Guthaben bis 100.000 € pro Person und Bank, bei Gemeinschaftskonten entsprechend mehr. Viele deutsche Banken sind zusätzlich Mitglied in freiwilligen Einlagensicherungsfonds, die über die gesetzliche Grenze hinausgehen. Bei Banken außerhalb Deutschlands lohnt sich ein Blick, unter welche nationale Einlagensicherung sie fallen.'
  - question: 'Was ist eine Festgeldleiter?'
    answer: 'Bei einer Festgeldleiter wird das Kapital auf mehrere Festgeldanlagen mit gestaffelten Laufzeiten aufgeteilt — zum Beispiel je ein Fünftel auf 1, 2, 3, 4 und 5 Jahre. Dadurch wird jedes Jahr ein Teilbetrag fällig, den man neu anlegen oder abheben kann. Das kombiniert die meist höheren Festgeldzinsen mit einer gewissen jährlichen Flexibilität.'
  - question: 'Lohnt sich Festgeld gegenüber Tagesgeld überhaupt?'
    answer: 'Das hängt vom Zinsumfeld ab. Bei normaler Zinsstruktur liegt der Festgeldzins für längere Laufzeiten meist über dem variablen Tagesgeldzins — als Prämie für den Verzicht auf Flexibilität. In Phasen fallender Zinserwartungen kann es sich lohnen, den aktuellen Zins mit Festgeld länger zu sichern; bei erwarteten Zinssteigerungen ist Tagesgeld oder kurzes Festgeld oft vorteilhafter.'
  - question: 'Sollte der Notgroschen auf Tagesgeld oder Festgeld liegen?'
    answer: 'Der Notgroschen gehört auf Tagesgeld, nicht auf Festgeld — der entscheidende Vorteil ist die jederzeitige Verfügbarkeit im Notfall, nicht die maximale Verzinsung. Geld, das über den Notgroschen hinausgeht und über einen bekannten Zeitraum nicht gebraucht wird, kann sinnvoll in Festgeld angelegt werden.'
sources:
  - title: 'Einlagensicherung in Deutschland — Fragen und Antworten'
    publisher: 'Bundesbank'
    url: 'https://www.bundesbank.de/de/aufgaben/bankenaufsicht/einlagensicherung'
  - title: 'Einlagensicherungsgesetz (EinSiG)'
...
| Zinssatz | Variabel | Fix über gesamte Laufzeit |
| Typische Laufzeiten | Keine (unbefristet) | 3–60 Monate |
| Reaktion auf Zinsänderungen | Sofort (positiv wie negativ) | Keine während der Laufzeit |
| Geeignet für | Notgroschen, kurzfristige Reserve | Geld mit bekanntem Bedarfszeitpunkt |
